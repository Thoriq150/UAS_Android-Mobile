...
public class SecondActivity extends AppCompatActivity {
    public static final String EXTRA_REPLY = "com.example.android.project_gabungan.extra.REPLY";
    ...
    protected void onCreate(Bundle SavedInstanceState){
        ...
        String isiSurat = muncul.getStringExtra(com.example.project_gabungan.FirstActivity.EXTRA_MESSAGE);
